...
Buy product { time_of_purchase, member, products: { product_id, amount, price_per_item, toal_price }}
Buy order { member, products, time_of_purchase }


Select prominent member
Select committee
Select committee member
Select member { from_stats }
Undo order

Select compucie

Member selection cosmetics

Don't show Gasten in member selection
